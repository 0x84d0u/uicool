...
export const SiteContainer = ({
    ...
    <div className={cn("w-full max-w-screen-tablet mx-auto px-4", className)}>
        {children}
    </div>
);
...
export const SiteSidebar = ({
    ...
    <aside
        className={cn(
            "hidden laptop:flex w-64 bg-muted text-muted-foreground border-r border-border flex-col",
            className
        )}
    >
        {children}
